...
|---|---|---|---|
| **SmartRobot Solutions / humanoidcenter.nl** ⭐ | Richard Kuijpers (richard@smartrobot.solutions, 06 42772727, Nijmegen) | **Samenwerking gestart 9/7** | Grote gevestigde NL-speler, **officieel Unitree/UBTECH/Agibot-distributeur**, bezit units + operators, doet event-inzet. Óók directe concurrent (levert zelf aan eindklanten; achterhaalde 16/7 zelf). **Strategie Thomas:** wij de online voorkant (leads), zij de uitvoering. **Reply verstuurd 9/7** (taak #58, als Thomas): warm/bewonderend, 16/7 bij hem gelaten, 2 open data (eind sept / half nov) voorgelegd + tarief/beschikbaarheid gevraagd, meeting aangeboden. Bal bij Richard. **Model (broker vs referral) nog OPEN** → in het gesprek beslissen; advies = broker (klant blijft van ons). ⚠️ Nooit klantnamen/venues/pijplijn delen. |
...
| **RobotShop EU** | Nathy (marketplace@robotshop.com, ticket T1121128) | ✅ Offerte + vragen beantwoord (25/6) | **Ons** | **U1 €29.925, U2 €34.200** (5% korting, ex btw, EU, 18mnd garantie, t/m 30 juli). Antwoord 25/6: **8% vanaf 3 units**, **45 dagen geldig**, en **geen reseller op Unitree** (mag niet van fabrikant, enkel volumekorting, case-by-case). Transactionele EU-fallback. **Opgehelderd 9/7 (PDF uitgelezen):** Bid 1482037 = **RB-Unt-100 "Unitree G1 Humanoid Robot (EU)" = de standaard G1, NIET de EDU.** €23.000 lijst, 5% = **€21.850 netto** (ex btw), 8-12 wk, 100% vooruit, 12 mnd garantie, t/m 30 juli. (Het dossier noemde Bid 1482037 eerder onterecht als "G1 EDU €29.925/€34.200"; die EDU-prijzen kwamen uit een aparte mail.) **Advies: nu niks kopen** (geen getekende klant + verhuur mogelijk via SmartRobot); bij koop eerst base-G1-distributeurprijs bij Dario opvragen. PDF in attachments/ (VPS) |
