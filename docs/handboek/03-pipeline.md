...
| **Kiwa — Erik Steegman** | Event **11 nov 2026, Expo Houten** (beurs Daken en Zaken); G1 geadviseerd | **✅ Offerte verstuurd 8/7 (als Lisa)** | **hen** | Volledige offerte (lead 200): G1 dagdeel €950 / dag €1.450, R1 €495/€750, incl. operator+verzekering, reiskosten €75, rondgang-voorbehoud. **Bal bij Erik** (optie kiezen). Evt. vriendelijke reminder over enkele dagen (event pas 11 nov). Ook via SmartRobot uit te voeren. |

## 🤝 Uitvoerings-partners (verhuur zonder eigen units)
| Partner | Contact | Status | Notitie |
|---|---|---|---|
| **SmartRobot Solutions / humanoidcenter.nl** ⭐ | Richard Kuijpers (richard@smartrobot.solutions, 06 42772727, Nijmegen) | **📅 Afspraak: di 14/7 10:00 ONLINE** | Grote gevestigde NL-speler, **officieel Unitree/UBTECH/Agibot-distributeur**, bezit units + operators, doet events al 10+ jaar. Óók directe concurrent (levert zelf aan eindklanten; achterhaalde 16/7 zelf). **Strategie Thomas:** wij de online voorkant (leads), zij de uitvoering. **Richard zei JA** (9/7 avond): "willen de uitvoering overnemen met commissie". **Afspraak ingepland 13/7** (taken #61/#62): dinsdag **14 juli 10:00 online**. 🔧 **Open vóór het gesprek: wij sturen nog een Google Meet-link** (Thomas maakt 'm, Claude mailt 'm). ⚠️ **KERNVRAAG voor het gesprek: wie factureert de klant / wie is contracthouder** — zijn "uitvoering overnemen met commissie" kan broker (klant blijft van ons, aanrader) OF lead-gen (klant naar hem) betekenen. Advies = broker. Nooit klantnamen/venues/pijplijn delen. Hij vindt lease nu te complex (past bij onze event-focus). |
