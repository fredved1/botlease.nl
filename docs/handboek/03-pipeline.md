...
| **BusinessWise — Tim Swager** (via DPG Media) | Event **16 juli 16:00-17:00**, entree-ontvangst met humanoid. Tel 06-21971403. | ❌ **Afgezegd 8/7 (net nee, #56)** | — | **16 juli bleek al bij SmartRobot geboekt** (Richard bevestigde het event; Tim shopte rond). Geen eigen unit + enige partner bedient de klant al direct → verloren. Eerlijk nee gestuurd + goodwill volgend event (dagdeeltarief, reiskosten eraf). Najaar kansrijk: dan met eigen unit ná handtekening. |
| **Van de Beek Advies — Bart** | Event **30 sept** (Agri & Food-kennissessie), 1+ humanoids, korte periode; plus **roadshow-idee** langs groene onderwijsinstellingen | **Reageerde 10/7: gaat in overleg, komt terug** | **hen** | Wacht op zijn terugkoppeling (locatie/dagdeel, aantal robots, roadshow-omvang). **Kandidaat om via SmartRobot uit te voeren.** Roadshow = potentieel structurele omzet. |
| **Kiwa — Erik Steegman** | Event **11 nov 2026, Expo Houten** (beurs Daken en Zaken); wil R1 of G1. Rol: blikvanger op stand + rondgang wandelpaden + fotomoment + begroeten. Tijd: hele beursdag of 11:00-15:00 | **✅ Offerte verstuurd 8/7 (als Lisa)** | **hen** | Volledige offerte (lead 200): G1 dagdeel €950 / dag €1.450, R1 €495/€750, incl. operator+verzekering, reiskosten €75, rondgang-voorbehoud. **Bal bij Erik** (optie kiezen). Evt. vriendelijke reminder over enkele dagen (event pas 11 nov). Kandidaat om via SmartRobot uit te voeren. ⚠️ **Onze offerteprijzen mogelijk te laag** vs SmartRobot-uitvoeringskosten → check tegen hun menukaart vóór Erik akkoord gaat (marge kan dun/negatief). |

## 🤝 Uitvoerings-partners (verhuur zonder eigen units)
| Partner | Contact | Status | Notitie |
|---|---|---|---|
| **SmartRobot Solutions / humanoidcenter.nl / HAC Schiedam** ⭐ | Richard Kuijpers (richard@smartrobot.solutions, 06 42772727, Nijmegen) + **Eli/Elias (events-lead, e-mail nog opvragen)** | **🤝 Partnership rond (14/7) — wacht op menukaart** | **Gesprek gehad 14/7** (Richard + Eli, online). Grote gevestigde NL-speler: **distributeur UBTech/EngineAI/Agibot**, opende net **HAC Schiedam** (RTL), krijgt units als eerste in EU, klanten Dura Vermeer/GOM/NS/Qualcomm/Danone. Óók concurrent (levert zelf), maar gelooft in partnerships. **⭐ Model bevestigd = broker:** *"jij blijft in lead, jouw klant, jij krijgt fee/commissie."* Twee sporen: **events** (wij door → zij uit → commissie, wij contracthouder) + **bedrijfsleads** (naar HAC om use-case te bewijzen, wij in lead + fee). **Zij sturen: (1) menukaart met prijzen, (2) lijst verhuurbare robots** (Eli trekt de kar) → onze site + eventprijzen realistisch maken (die zijn nu te laag: hun voorbereiding/verzekering/borg zit er niet in). Thomas kiest bewust **ROYAAL** met leads (relatie > leverage). **Vervolg:** Eli-sessie (events doorlopen), HAC-bezoek met leads, evt. do 17/7 A'dam. ⚠️ Commissie-% nog niet op papier (bij 1e opdracht vastleggen). |
| **RobotXperience / robotverhuur.nl** | info@robotverhuur.nl, Almere | Koud (7/7, geen reactie) | Verhuurt G1 mét operator, **GEEN lease-concurrent** = veiligste fulfilment-partner (levert niet zelf aan eindklanten). Nog nabellen. |
...
| **RobotShop EU** | Nathy (marketplace@robotshop.com, ticket T1121128) | ✅ Offerte + vragen beantwoord (25/6) | **Ons** | **U1 €29.925, U2 €34.200** (5% korting, ex btw, EU, 18mnd garantie, t/m 30 juli). Antwoord 25/6: **8% vanaf 3 units**, **45 dagen geldig**, en **geen reseller op Unitree** (mag niet van fabrikant, enkel volumekorting, case-by-case). Transactionele EU-fallback. **Bevestigd 9-10/7 (Nathy):** Bid 1482037 = **RB-Unt-100 "Unitree G1 (EU)" = standaard G1, NIET EDU.** €23.000 lijst, 5% = **€21.850 netto** (ex btw), ETA **10-12 wk** NL-warehouse, 100% vooruit, 12 mnd garantie, t/m 30 juli. ⚠️ **Niet-functionele (cosmetische) handen** — voor events prima (lopen/zwaaien/begroeten), kan niks pakken. (Dossier noemde dit eerder onterecht "G1 EDU €29.925/€34.200"; die EDU-prijzen kwamen uit een aparte mail.) **Loop afgesloten 10/7 (#60):** geen order nu, kom terug bij deal. **Advies: nu niks kopen**; bij koop eerst base-G1-distributeurprijs bij Dario opvragen (€21.850 is hoog voor base G1). PDF in attachments/ (VPS) |
