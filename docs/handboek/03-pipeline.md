...
| **RobotShop EU** | Nathy (marketplace@robotshop.com, ticket T1121128) | ✅ Offerte (Bid 1482037) | **Ons** | **U1 €29.925, U2 €34.200** (5% korting, ex btw, EU, 18mnd garantie, t/m 30 juli). **Geen reseller mogelijk** (contractueel met fabrikant), 5% is standaard, heroverwegen bij grotere aantallen. Dus geen marge-partner, wel simpele EU-route (vooral U2 goedkoper dan China). Concept-reply klaar (werklijst): volumedrempel + verbetering gevraagd. PDF in docs/leveranciers/ |
...
| **NEURA Robotics (DE)** | Kristina Naumoska | In gesprek | **Ons** | Kristina kwalificeert ons rond **NEURA Gym** (vereist intern budget + strategisch besluit). Past matig op ons reseller/lease-model. Concept-reply klaar (werklijst): ons model verhelderd + gevraagd of er een reseller/partner-track voor de 4NE-1 bij eindklanten is. Haalden $1,4B op |
