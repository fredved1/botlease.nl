...
|---|---|---|---|
| **SmartRobot Solutions / humanoidcenter.nl** ⭐ | Richard Kuijpers (richard@smartrobot.solutions, 06 42772727, Nijmegen) | **✅ JA op samenwerking (10/7) — koffie plannen** | Grote gevestigde NL-speler, **officieel Unitree/UBTECH/Agibot-distributeur**, bezit units + operators, doet events al 10+ jaar. Óók directe concurrent (levert zelf aan eindklanten; achterhaalde 16/7 zelf). **Strategie Thomas:** wij de online voorkant (leads), zij de uitvoering. **Richard zei JA** (9/7 avond): "willen de uitvoering overnemen met commissie", wil koffie. **Reply verstuurd 10/7** (taak #59): koffie Nijmegen begin volgende week, hij kiest moment. **Bal bij Richard** (dag/tijd). ⚠️ **KERNVRAAG voor het gesprek: wie factureert de klant / wie is contracthouder** — zijn "uitvoering overnemen met commissie" kan broker (klant blijft van ons, aanrader) OF lead-gen (klant naar hem) betekenen. Advies = broker. Nooit klantnamen/venues/pijplijn delen. Hij vindt lease nu te complex (past bij onze event-focus). |
