...
AI_ACT_GUIDE = {
    ...
    "title": "EU AI-Act + Machineverordening voor humanoïde robots — gids 2026/2027 | BotLease",
...
ABOUT = {
    ...
    "meta_desc": "BotLease is opgericht in 2026 in Eindhoven Brainport. Wij maken humanoïde robots toegankelijk voor het Nederlandse MKB via all-in operational lease. Geen vendor lock-in, onafhankelijk advies, EU-gebouwde modellen prioriteit.",
    ...
    "sections": [
        {
            "id": "missie",
            "h": "Missie: humanoid robotica democratiseren",
            "body": [
                "De eerste generatie humanoïde robots (Apollo, Figure, Atlas) gaat naar Mercedes, BMW en Hyundai. Naar OEMs met budgetten van honderden miljoenen. Het Nederlandse MKB krijgt niets — geen pilot-toegang, geen prijspunt, geen support.",
                "Daar zit een gat. Een Nederlandse 3PL met 50 medewerkers heeft net zo goed baat bij humanoid-werk als BMW Spartanburg. Maar het MKB heeft geen team van 5 robotica-ingenieurs om een $50M deal met Figure te onderhandelen.",
                "BotLease maakt humanoid-leasing toegankelijk voor bedrijven die niet groot genoeg zijn om direct met Apptronik of NEURA te dealen. Wij bouwen de relaties met fabrikanten, wij verzorgen de compliance (CE + AI-Act), wij doen het onderhoud. Voor jou: één maandfactuur, geen verrassingen.",
            ],
        },
        {
            "id": "waarom-wij",
        ...
        },
        {
            ...
            "h": "Team",
            "body": [
                "BotLease B.V. is in 2026 opgericht in Eindhoven Brainport (KvK XXXXXXXX). Het team combineert achtergronden uit operational leasing (Pon, Athlon), robotica (TU Delft, TU/e) en SaaS-engineering.",
...
METHODOLOGY = {
    "slug": "methodologie",
    "title": "Methodologie — hoe BotLease robots evalueert en lease-prijzen berekent | BotLease",
