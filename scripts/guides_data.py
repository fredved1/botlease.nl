...
PILLAR_GUIDE = {
    ...
    "tldr": [
        "Lease-prijzen lopen van €290/mnd (Unitree R1, instap) tot €5.950/mnd (NEURA 4NE-1 Gen 3.5, industrieel). All-in inclusief gebruiksklare oplevering, onderhoud, swap-SLA en verzekering.",
    ...
    "sections": [
        ...
        },
        {
            ...
            "body": [
                ...
                "<b>EU-gebouwd - strategische kern (3 modellen):</b>",
        ...
        },
        {
            ...
            "body": [
                ...
                "<b>Formule:</b> Lease prijs/mnd = (Aanschafprijs / 36 maanden) + 25% service + 8% verzekering + 30% marge. Voor een €22.000 robot (instapklasse) komt dat neer op ongeveer €1.295/mnd. Voor een €95.000-€110.000 robot ongeveer €5.750-€6.650/mnd.",
                "<b>Wat zit er in:</b> Gebruiksklare oplevering met korte uitleg, onderhoud en onderdelen via de leverancier, een vervangende unit bij storing (doorgaans binnen enkele werkdagen), WA-verzekering per inzet geregeld, en een Nederlandstalige helpdesk op werkdagen.",
        ...
        },
        {
            ...
            "body": [
                ...
                "<b>Wat doet BotLease?</b> Wij dragen de compliance-last als <i>provider</i> én helpen jou als <i>deployer</i> voldoen aan je verplichtingen. EU-gebouwde robots (NEURA, Pollen) hebben de meeste documentatie al klaar; voor Aziatische modellen voeren wij de conformity assessment per locatie uit.",
                "<b>Wat moet jij doen als werkgever?</b> Als gebruiker ben je verantwoordelijk voor een veilige inzet op de werkvloer, zoals een risicobeoordeling en het instrueren van je mensen. Wij leveren de CE- en conformiteitsdocumentatie aan zodat die basis op orde is.",
            ],
        },
        {
            "id": "pilot",
            ...
            "body": [
                ...
                "<b>Week 1: Deployment.</b> Robot op locatie. We leveren de robot gebruiksklaar op en geven een korte operator-instructie.",
        ...
        },
        {
            ...
            "body": [
                ...
                "<b><a href=\"/sectoren/3pl-fulfillment\">3PL & e-commerce fulfillment</a>:</b> 11-14 maanden ROI. Een UBTECH Walker S2 of (vanaf 2027) Apollo vervangt ~1,3 FTE in 2-ploegen. Bij €28/uur loonkost en 1,3 FTE × 2.080 uur/jaar = €76k bespaarde loonkosten/jaar. Met €5.750/mnd lease (€69.000/jaar) is het directe loonkosten-voordeel beperkt (~€7k/jaar) - de echte winst zit in nachturen en piekcapaciteit.",
    ...
    "faq": [
        ...
        ("Is humanoide robot leasing AVG/GDPR compliant?",
         "Ja - camera- en sensorstreams blijven on-prem of in EU-cloud (Hetzner Frankfurt). BotLease sluit een verwerkersovereenkomst (DPA) per klant. EU-gebouwde modellen (NEURA, Pollen) zijn extra preferent voor GDPR-gevoelige werkomgevingen."),
        ...
        ("Wat als de robot stuk gaat?",
         "Bij een storing regelen we een vervangende unit, doorgaans binnen enkele werkdagen. Reparatie loopt via de leverancier."),
        ...
        ("Heb ik technische kennis nodig om een robot te bedienen?",
         "Nee. De robot wordt gebruiksklaar geleverd en we geven bij oplevering een korte uitleg. Voor dagelijks gebruik is geen technische kennis nodig."),
...
AI_ACT_GUIDE = {
    ...
    "tldr": [
        ...
        "Werkgever (deployer) verplichtingen: een risicobeoordeling op de werkvloer, transparantie naar werknemers en monitoring tijdens gebruik. BotLease levert hiervoor de CE- en conformiteitsdocumentatie aan.",
    ],
    "sections": [
        {
            "id": "context",
        ...
        },
        {
            ...
            "body": [
                ...
                "<ul><li><b>Risicobeoordeling op de werkvloer</b> - werkzones, route-conflicten, mens-robot interacties. Dit is een verantwoordelijkheid van de werkgever; wij denken mee en leveren de documentatie.</li><li><b>Transparantieverklaring aan werknemers</b> - vooral OR / vakbond moet betrokken zijn. Welke data wordt verzameld? Wie heeft toegang?</li><li><b>Operator-instructie</b> - minstens 1 persoon op locatie moet de robot kunnen stoppen en herstarten; bij oplevering leggen we dat uit.</li><li><b>Monitoring tijdens gebruik</b> - houd incidenten, uptime en foutpercentage bij.</li><li><b>Incident-meldingsplicht</b> - bij ernstige incidenten (letsel, dataverlies) meld je bij de AI-Office (Brussel) binnen 15 dagen.</li><li><b>Verwerkersovereenkomst (DPA)</b> - voor AVG/GDPR-conformiteit van camera- en sensordata.</li></ul>",
        ...
        },
        {
            ...
            "body": [
                ...
                "<b>Stappen:</b>",
                "<ul><li>Week 1: intake. Samen kijken we naar de werkplek en de taak; de risicobeoordeling op de werkvloer ligt bij de werkgever.</li><li>Week 2: conformity assessment voor de Unitree H1-2 in deze specifieke deployment-situatie. Duurt extra tijd omdat het een Chinees model is.</li><li>Week 3: deployment + korte operator-instructie. OR/personeel ingelicht via transparantieverklaring. Verwerkersovereenkomst getekend.</li><li>Week 4: productie. Houd uptime en incidenten bij.</li><li>2 augustus 2026: extra compliance-check - geen acties nodig want we hebben de assessment al gedaan.</li><li>20 januari 2027: Machineverordening-update; we leveren de bijgewerkte documentatie aan.</li></ul>",
...
GLOSSARY = {
    ...
    "terms": [
        ...
        ("Swap-SLA", "Afspraak voor vervanging bij defect: bij een storing regelen we een vervangende unit, doorgaans binnen enkele werkdagen."),
...
METHODOLOGY = {
    ...
    "sections": [
        ...
        },
        {
            ...
            "body": [
                "Bij defect of storing regelen we een vervangende unit, doorgaans binnen enkele werkdagen.",
                "<b>Service-niveau:</b>",
                "<ul><li><b>Storing:</b> we reageren op werkdagen en regelen een vervangende unit, doorgaans binnen enkele werkdagen.</li><li><b>Kleine problemen:</b> lossen we op afstand of via de leverancier op.</li></ul>",
                "<b>Dekkingsgebied:</b> heel Nederland; een vervangende unit regelen we doorgaans binnen enkele werkdagen.",
                "<b>Reparatie:</b> loopt via de leverancier; jij houdt ondertussen een vervangende unit.",
